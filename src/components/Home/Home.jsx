...
function Home() {
  return (
    <div className={style.home}>
      <section
        className={`${style.home__section} ${style.home__section_style_one}`}
      >
        <div className={`${style.home__section_content} container`}>
          <div>
      ...
      <section
        className={`${style.home__section} ${style.home__section_style_two}`}
      >
        <div className={`${style.home__section_content} container`}>
          <div>
